                        ...
                        <div class="row">
                            <div class="col-auto mb-3 mb-md-0">
                                @if ($order->image)
                                    ...
                                    <img src="{{ route('admin.orders.image', [$order->id, $order->image]) }}" class="elevation-2 mb-0" width="200px" alt="User Image">
                                @endif
                            </div>
                            ...
                            <div class="col-auto">
                                @if ($order->image_signature)
                                    ...
                                    <img src="{{ route('admin.orders.image', [$order->id, $order->image_signature]) }}" class="elevation-2" width="200px" alt="User Image">
                                @endif
                            </div>
                        </div>
                    </div>
